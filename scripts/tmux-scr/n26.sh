...
function n26tmux {
	...
	tmux new-window -t N26:6 -n Terraform
	tmux new-window -t N26:7 -n Saito
	...
	tmux send-keys -t N26:6 "pushd $BASE/section9_terraform && clear" C-m
	tmux send-keys -t N26:7 "pushd $BASE/section9_saito && clear" C-m
