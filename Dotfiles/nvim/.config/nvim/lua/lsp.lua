...
lspconfig.efm.setup({
    root_dir = lspconfig.util.root_pattern(".git", "/home/canus/Scripts",
                                           "/home/contre"),
    filetypes = vim.tbl_keys(languages),
    cmd = {
        "/home/contre/go/bin/efm-langserver", "-logfile",
        "/home/contre/.cache/nvim/lsp.log", "-loglevel", "5"
    },
    init_options = {documentFormatting = true, codeAction = true},
    filetypes = {
        "css", "html", "javascript", "bash", "sh", "yaml", "zsh", "lua",
        "markdown", "python"
    },
    settings = {
        languages = languages,
