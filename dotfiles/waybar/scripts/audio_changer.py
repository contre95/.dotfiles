...
wofi_command = f"echo '{output}' | wofi --show=dmenu --allow-markup --define=hide_search=false --location=top --width=200 --height=120 --xoffset=-200"
...
if wofi_process.returncode != 0:
    print(wofi_process.stderr)
    print(wofi_process.stdout)
